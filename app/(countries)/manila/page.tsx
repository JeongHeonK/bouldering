...
export default function Page() {
  ...
  return (
    <>
      <section className="bg-manila flex h-[568px] w-full flex-col items-center justify-center bg-cover bg-center bg-no-repeat lg:h-[940px]">
        <h2 className="mb-2 text-7xl font-semibold text-white">
          Manila Bouldering Club
        </h2>
